...
public class Main extends HttpServlet {
    List<Transaction> transactionList = Stream.of(new Transaction(new Date(2024,11,9),10000.0,"vineeth","Family"),
            new Transaction(new Date(2025,02,19),50000.0,"Hithesh","Emergency"),
            new Transaction(new Date(2022,12,18),10000.0,"Sukesh","Bills"),
            new Transaction(new Date(2025,06,5),10000.0,"Vani","Emergency"),
            new Transaction(new Date(2024,2,20),20000.0,"Vimala","Friends")).collect(Collectors.toList());
